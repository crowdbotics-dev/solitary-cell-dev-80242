"""
Django settings for solitary_cell_dev_80242 project.
...
ROOT_URLCONF = 'solitary_cell_dev_80242.urls'
...
WSGI_APPLICATION = 'solitary_cell_dev_80242.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_cell_dev_80242 API",
    "DESCRIPTION": "API documentation for solitary_cell_dev_80242 App",
    "VERSION": "v1",
}
